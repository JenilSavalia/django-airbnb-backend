...
from .serializers import PropertyListSerializer,PropertiesDetailSerializer,ReservationsListSerializer
...
def property_list(request):
    ...
    if category and category != 'undefined':
        properties = properties.filter(catregory=category)
...
def properties_detail(request,pk):
    ...
    serialiser = PropertiesDetailSerializer(property,many=False)
